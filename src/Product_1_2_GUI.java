...
public class Product_1_2_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Product_1_2_GUI frame = new Product_1_2_GUI(CustomerID);
	...
	{
		Product_1_2_GUI.CustomerID = customerID;
	}
	
	
	public Product_1_2_GUI(int customerID) {
	...
	private void GOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		ShowProduct_2 table = new ShowProduct_2(sleepSense, CustomerID);
