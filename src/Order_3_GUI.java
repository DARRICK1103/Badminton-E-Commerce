...
public class Order_3_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Order_3_GUI frame = new Order_3_GUI(productID, customerID);
	...
	{
		Order_3_GUI.productID = productID;
		
	}
	
	public void updateCus(int customerID)
	{
		Order_3_GUI.customerID = customerID;
	}
	 ...
	 * Create the frame.
	 */
	public Order_3_GUI(int productID, int customerID) {
		...
		lblPrice.setBounds(35, 326, 348, 62);
		...
		btnNEXT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        		...
        		if(test == true) //insert quantity as integer
        		{
        			...
        			PaymentManager.insert(payment); //insert new payment
        			...
        			int paymentID = PaymentManager.getLatestID();
        			//find.setText("id ::" + paymentID);
        			...
        			order.setORDER_DATE(localDate.toString()); 
