...
public class ShowProduct_2 extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					...
					ShowProduct_2 frame = new ShowProduct_2(selection, customerID);
	...
	{
		ShowProduct_2.customerID = CustomerID;
		
	}
	public void updateSe(int selection)
	{
		ShowProduct_2.selection = selection;
	}

	
	
	
	public ShowProduct_2(int selection, int CustomerID) {
	...
	private void openNext()
	{
		...
		try {
			Order_3_2_GUI order = new Order_3_2_GUI(productID, customerID); 
	...
	private void btnGO_BACKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		//JOptionPane.showMessageDialog(this, "Delete all your order records ");
